...
export default function Navigation({ children }: { children: JSX.Element | JSX.Element[] }) {
  ...
  const profileLink = useMemo<string | null>(() => {
      ...
      <div className="navbar-container" style={{ width: width > 600 ? "200px" : "150px", minWidth: width > 600 ? "200px" : "150px" }}>
        <div className="top-part">
          <Button
            ...
            onClick={() => setIsGratitudeModalOpened(true)}
            style={{ width: "100%" }}
          >
            New Message
          </Button>
          ...
          <Tooltip label="Your messages" style={{ width: "100%" }}>
            <Link href='/only_me' passHref>
              <a className={"row " + (pathname === "/only_me" ? "active" : "")}>
                {pathname === "/only_me" ? (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M231.9 220a7.8 7.8 0 0 1-6.9 4H31a7.8 7.8 0 0 1-6.9-4a7.7 7.7 0 0 1 0-8a120.7 120.7 0 0 1 67.1-54.2a72 72 0 1 1 73.6 0a120.7 120.7 0 0 1 67.1 54.2a7.7 7.7 0 0 1 0 8Z"></path></svg>
                ) : (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M235.4 210a124.2 124.2 0 0 0-61.8-53.2a76 76 0 1 0-91.2 0A124.2 124.2 0 0 0 20.6 210a12 12 0 0 0 20.8 12a100 100 0 0 1 173.2 0a12.1 12.1 0 0 0 10.4 6a11.7 11.7 0 0 0 6-1.6a12 12 0 0 0 4.4-16.4ZM76 96a52 52 0 1 1 52 52a52 52 0 0 1-52-52Z"></path></svg>
                )}
                <div className="row-label">Private</div>
              </a>
            </Link>
          </Tooltip>
          <Tooltip label="Messages of your friends" style={{ width: "100%" }}>
            <Link href='/friends' passHref>
              <a className={"row " + (pathname === "/friends" ? "active" : "")}>
                {pathname === "/friends" ? (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M64 140a7.9 7.9 0 0 1-8 8H12a8.2 8.2 0 0 1-7.2-4.4a8.2 8.2 0 0 1 .8-8.4A67.8 67.8 0 0 1 33 113.5a40 40 0 1 1 66.3-37a8.1 8.1 0 0 1-3.8 8.4a64.3 64.3 0 0 0-27.8 33.8A61.6 61.6 0 0 0 64 140Zm186.4-4.8a67.8 67.8 0 0 0-27.4-21.7a40 40 0 1 0-66.3-37a8.1 8.1 0 0 0 3.8 8.4a64 64 0 0 1 27.8 33.8A61.6 61.6 0 0 1 192 140a7.9 7.9 0 0 0 8 8h44a8 8 0 0 0 6.4-12.8Zm-93.2 42.9a48 48 0 1 0-58.4 0a72.1 72.1 0 0 0-35.6 34.4a7.8 7.8 0 0 0 .5 7.7a7.8 7.8 0 0 0 6.7 3.8h115.2a7.8 7.8 0 0 0 6.7-3.8a7.8 7.8 0 0 0 .5-7.7a72.1 72.1 0 0 0-35.6-34.4Z"></path></svg>
                ) : (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M164.3 177.2a52 52 0 1 0-72.6 0a75.5 75.5 0 0 0-32.1 33.5a12 12 0 0 0 21.6 10.6a52 52 0 0 1 93.6 0a12 12 0 0 0 10.8 6.7a12.3 12.3 0 0 0 5.2-1.2a12 12 0 0 0 5.6-16.1a75.5 75.5 0 0 0-32.1-33.5ZM100 140a28 28 0 1 1 28 28a28.1 28.1 0 0 1-28-28Zm151.2 9.6a12 12 0 0 1-16.8-2.4a47.4 47.4 0 0 0-31.6-18.7a12 12 0 0 1-9.9-9.1a7.8 7.8 0 0 1-.5-1.4a11.9 11.9 0 0 1 8.6-14.6a20 20 0 1 0-23.1-28a12 12 0 1 1-21.6-10.3a44 44 0 1 1 73.4 47.2a71.1 71.1 0 0 1 23.9 20.5a12 12 0 0 1-2.4 16.8Zm-198-21.1a47.4 47.4 0 0 0-31.6 18.7A12.2 12.2 0 0 1 12 152a12.2 12.2 0 0 1-7.2-2.4a12 12 0 0 1-2.4-16.8a71.1 71.1 0 0 1 23.9-20.5a44 44 0 1 1 73.4-47.2a12 12 0 1 1-21.6 10.3a20 20 0 1 0-23.1 28a11.9 11.9 0 0 1 8.6 14.6a7.8 7.8 0 0 1-.5 1.4a12 12 0 0 1-9.9 9.1Z"></path></svg>
                )}
                <div className="row-label">Friends</div>
              </a>
            </Link>
          </Tooltip>
          <Tooltip label="Messages of everyone" style={{ width: "100%" }}>
            <Link href='/public' passHref>
              <a className={"row " + (pathname === "/public" ? "active" : "")}>
                {pathname === "/public" ? (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="m225.9 163.2l.3-1a103.7 103.7 0 0 0 0-68.4l-.3-1A104.4 104.4 0 0 0 128 24a104.2 104.2 0 0 0-97.9 68.8l-.3 1a103.7 103.7 0 0 0 0 68.4l.3 1A104.2 104.2 0 0 0 128 232a104.2 104.2 0 0 0 97.9-68.8ZM128 45.6A108.6 108.6 0 0 1 153.5 88h-51A108.6 108.6 0 0 1 128 45.6ZM102.5 168h51a108.6 108.6 0 0 1-25.5 42.4a108.6 108.6 0 0 1-25.5-42.4Zm-4.2-16a126.4 126.4 0 0 1 0-48h59.4a127.6 127.6 0 0 1 2.3 24a126.8 126.8 0 0 1-2.3 24Zm75.7-48h38.7a88.9 88.9 0 0 1 0 48H174a145 145 0 0 0 0-48Zm32.4-16h-36a128.7 128.7 0 0 0-24.1-46.1A88.6 88.6 0 0 1 206.4 88Zm-60.1 126.1a128.7 128.7 0 0 0 24.1-46.1h36a88.3 88.3 0 0 1-60.1 46.1Z"></path></svg>
                ) : (
          ...
          <Tooltip label="Website presentation (Home)" style={{ width: "100%" }}>
            <Link href='/' passHref>
              <a className={"row " + (pathname === "/" ? "active" : "")}>
                {pathname === "/" ? (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M128 24a104 104 0 1 0 104 104A104.2 104.2 0 0 0 128 24Zm36 72a12 12 0 1 1-12 12a12 12 0 0 1 12-12Zm-72 0a12 12 0 1 1-12 12a12 12 0 0 1 12-12Zm84.5 60a56 56 0 0 1-97 0a8 8 0 1 1 13.8-8a40.1 40.1 0 0 0 69.4 0a8 8 0 0 1 13.8 8Z"></path></svg>
                ) : (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M128 20a108 108 0 1 0 108 108A108.1 108.1 0 0 0 128 20Zm0 192a84 84 0 1 1 84-84a84.1 84.1 0 0 1-84 84ZM76 108a16 16 0 1 1 16 16a16 16 0 0 1-16-16Zm72 0a16 16 0 1 1 16 16a16 16 0 0 1-16-16Zm32 50a60.1 60.1 0 0 1-104 0a12 12 0 0 1 20.8-12a36 36 0 0 0 62.4 0a12 12 0 1 1 20.8 12Z"></path></svg>
                )}
                <div className="row-label">Website</div>
              </a>
            </Link>
          </Tooltip>
          <Tooltip label="Frequently asked questions" style={{ width: "100%" }}>
            <Link href='/faq' passHref>
              <a className={"row " + (pathname === "/faq" ? "active" : "")}>
                {pathname === "/faq" ? (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M128 24a104 104 0 1 0 104 104A104.1 104.1 0 0 0 128 24Zm0 168a12 12 0 1 1 12-12a12 12 0 0 1-12 12Zm8-48.9v.9a8 8 0 0 1-16 0v-8a8 8 0 0 1 8-8a20 20 0 1 0-20-20a8 8 0 0 1-16 0a36 36 0 1 1 44 35.1Z"></path></svg>
                ) : (
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="M128 20a108 108 0 1 0 108 108A108.1 108.1 0 0 0 128 20Zm0 192a84 84 0 1 1 84-84a84.1 84.1 0 0 1-84 84Zm16-36a16 16 0 1 1-16-16a16 16 0 0 1 16 16Zm24-68a40 40 0 0 1-40 40a12 12 0 0 1 0-24a16 16 0 1 0-16-16a12 12 0 0 1-24 0a40 40 0 0 1 80 0Z"></path></svg>
                )}
                <div className="row-label">FAQ</div>
              </a>
            </Link>
          </Tooltip>
          {(roles?.is_admin || roles?.is_moderator) &&
            <Tooltip label="Moderation" style={{ width: "100%" }}>
              <Link href='/mods' passHref>
                <a className={"row " + (pathname === "/mods" ? "active" : "")}>
                  <svg viewBox="0 0 256 256" width="20px" height="20px"><path fill="#FFFFFF" d="m114.2 40l-88 152A16 16 0 0 0 40 216h176a16 16 0 0 0 13.8-24l-88-152a15.9 15.9 0 0 0-27.6 0Z" opacity=".2"></path><path fill="#FFFFFF" d="M120 144v-32a8 8 0 0 1 16 0v32a8 8 0 0 1-16 0Zm116.8 68a23.9 23.9 0 0 1-20.8 12H40a23.9 23.9 0 0 1-20.7-36l87.9-152a24 24 0 0 1 41.6 0l87.9 152a23.7 23.7 0 0 1 .1 24Zm-13.9-16l-88-152a8 8 0 0 0-13.8 0l-88 152a7.8 7.8 0 0 0 0 8a7.9 7.9 0 0 0 6.9 4h176a7.9 7.9 0 0 0 6.9-4a7.8 7.8 0 0 0 0-8ZM128 168a12 12 0 1 0 12 12a12 12 0 0 0-12-12Z"></path></svg>
                  <div className="row-label">Moderation</div>
                </a>
              </Link>
            </Tooltip>
          }
        ...
        <div style={{ width: "100%" }}>
          <Button
            variant={"outline"}
            leftIcon={<svg viewBox="0 0 256 256" height="20px" width="20px"><path fill="#228be6" d="m224.5 136.5l-42 42a12 12 0 0 1-8.5 3.5a12.2 12.2 0 0 1-8.5-3.5a12 12 0 0 1 0-17L187 140h-83a12 12 0 0 1 0-24h83l-21.5-21.5a12 12 0 0 1 17-17l42 42a12 12 0 0 1 0 17ZM104 204H52V52h52a12 12 0 0 0 0-24H48a20.1 20.1 0 0 0-20 20v160a20.1 20.1 0 0 0 20 20h56a12 12 0 0 0 0-24Z"></path></svg>}
